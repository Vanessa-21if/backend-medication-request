...
def read_pacientes_from_mongodb(collection):
    try:
...
def display_pacientes(patient_list):
    if patient_list:
...
if __name__ == "__main__":
    ...
    pacientes = read_pacientes_from_mongodb(collection)
    
    # Mostrar los datos de los pacientes
    display_pacientes(pacientes)
